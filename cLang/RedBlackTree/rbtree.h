...
void rbtree_delete(rbtree y, void *key, compare_func compare);
...
static node new_node(void *key, color node_color, node left, node rigth);
static node lookup_node(rbtree t, void *key, compare_func compare);
static void rotate_left(rbtree t, node n);
static void rotate_right(rbtree t, node n);

//the case for insertition and deletion (the conditions to be checked)
